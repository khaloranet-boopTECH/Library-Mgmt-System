...
class Library:
    ...
    def __init__(self,master):
        self.master=master
        self.master.title("Ashoka Library Management System")
        self.master.geometry('1350x750+0+0')
        ...
        ListOfBooks = ['Cyber Security','Data Structures with','Core Java','Deep Machine Learning', 'Emerging Technology','Big Data Analytics','Ethical Hacking',
                       'Block Chain Technology','Computer Organization & Architecture','DBMS','DotNet Technology','Operating Systems']
